    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('proforma_invoices.index') }}" class="form-inline mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            @if ($month || $year || $status)
                                <a href="{{ route('proforma_invoices.index') }}" class="btn btn-secondary btn-sm mr-1 d-inline-flex align-items-center">
                                    <i class="fas fa-times mr-1"></i>Clear
                                </a>
                            @endif
                            <a href="{{ route('proforma_invoices.export_excel', request()->query()) }}" class="btn btn-success btn-sm d-inline-flex align-items-center">
