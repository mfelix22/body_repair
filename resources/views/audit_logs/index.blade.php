                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="action" class="form-control">
                                            ...
                                            <option value="deleted" {{ request('action') === 'deleted' ? 'selected' : '' }}>
                                                Deleted</option>
                                            <option value="printed" {{ request('action') === 'printed' ? 'selected' : '' }}>
                                                Printed</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <tbody>
                            @forelse ($auditLogs as $log)
                                <tr>
                                    ...
                                    <td>
                                        @if ($log->action === 'printed' && !empty($log->new_values['document_number']))
                                            <i class="fas fa-print text-info mr-1"></i>
                                            <strong>{{ $log->new_values['document_number'] }}</strong>
                                            @if (!empty($log->new_values['printed_at']))
                                                <br><small class="text-muted">at
                                                    {{ $log->new_values['printed_at'] }}</small>
                                            @endif
